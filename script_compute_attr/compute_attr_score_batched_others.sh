...
# Auto-detect number of available GPUs (run inside an srun --gres=gpu:4 session).
...
# layers 15 and 17 already complete (all 11 datasets); skip to save resume overhead
layer_indices=(21)
data_file_names=(
    "empathy_gpt"
    "modesty_gpt"
...
do
    output_dir="${output_root}/llama_attr_l${layer_index}_cos"
