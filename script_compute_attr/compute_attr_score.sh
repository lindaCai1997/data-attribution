...
methods=("residual_change_treatment" "residual_change" "residual_diff")
    ...
    do
        for method in "${methods[@]}"
            do
                ...
                output_dir_path="${output_dir}/${data_file_name}/${method}/"
                
                echo "Running with method: ${method}, output_dir: ${output_dir_path}"
                torchrun --standalone --nproc_per_node=${NUM_GPUS} -m main \
                    --data ${data_file_path} \
